...
import { comicsId } from '../config/Helpers.js';
	...
	useEffect(
		...
		() => {
			...
			async function fetchData() {
				try {
					const { data: show } = await axios.get(comicsId(props.match.params.id));
					console.log(show)
					setShowData(show);
					setLoading(false);
				} catch (e) {
		...
		return (
			<Card className={classes.card} variant='outlined'>
				...
				<dl>
								...
								<dl>			
								<dt className='title'>Characters which appear in this comic :</dt>
